<?php
// ====================== index.php ======================
// ПОВНІСТЬЮ ГОТОВИЙ сайт Vilniaus valymas (литовською)
...
<head>
    ...
    <!-- SEO META -->
    <title>Profesionalus valymas Vilniuje | Vilniaus valymo paslaugos | Butų, biurų ir po remonto valymas 2026</title>
    <meta name="description" content="Profesionalus valymas Vilniuje ✓ Butų, biurų, po remonto ir generalinis valymas ✓ Ekologiškos priemonės, profesionalūs dulkių siurbliai, šluostės, šluostės ir švabrės ✓ Greitas išvykimas po visą Vilnių ✓ 100% švaros garantija ✓ Fiksuota kaina ✓ Tel: +370 644 74842">
    <meta name="keywords" content="valymas Vilnius, Vilniaus valymas, butų valymas Vilnius, biurų valymas Vilnius, valymas po remonto Vilnius, generalinis valymas Vilnius, ekologiškas valymas Vilnius">
    <meta name="robots" content="index, follow, max-image-preview:large">
    <meta name="author" content="Ruslan Bilohash">
    <meta name="theme-color" content="#10b981">
    <link rel="canonical" href="https://bilohash.com/index.php">

    <!-- OPEN GRAPH -->
    <meta property="og:title" content="Profesionalus valymas Vilniuje | Butų, biurų ir po remonto valymas">
    <meta property="og:description" content="Greitas ir profesionalus valymas Vilniuje. Ekologiškos priemonės, kokybės garantija, greitas atsakas. +370 644 74842">
    <meta property="og:image" content="https://picsum.photos/seed/professional-cleaning-vilnius-hero-2026/1200/630">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:url" content="https://bilohash.com/index.php">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="lt_LT">
    <meta property="og:site_name" content="Vilniaus valymas">

    <!-- TWITTER CARDS -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Profesionalus valymas Vilniuje | Butų, biurų ir po remonto">
    <meta name="twitter:description" content="Profesionalus valymas Vilniuje ✓ Butai • Biurai • Po remonto • Ekologiškos priemonės • +370 644 74842">
...
<body class="font-sans bg-gray-50 text-gray-900">
    ...
    <header class="bg-white shadow-lg sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <span class="text-3xl font-bold tracking-tight">VILNIAUS VALYMAS</span>
                </div>
            </div>
    ...
    <section class="hero-bg h-screen flex items-center text-white">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <h1 class="text-5xl md:text-7xl font-bold leading-none mb-6 tracking-tighter">
                PROFESIONALUS VALYMAS<br>VILNIUJE 2026
            </h1>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white border border-gray-100 rounded-3xl overflow-hidden card-hover">
                    ...
                    <div class="p-8">
                        ...
                        <p class="text-gray-600">Kasdienis, gilus ir po remonto biurų valymas Vilniuje. Palaikome švarą verslo centruose, bendradarbystės erdvėse. Profesionalios valytojos su dulkių siurbliais ir ekologiškomis priemonėmis.</p>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-3 text-gray-600">Mūsų specialistai atvyksta patogiu jums laiku su visa įranga ir ekologiškomis priemonėmis.</p>
                </div>
                <div class="text-center">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-3 text-gray-600">Patikriname viską ir perduodame tobulai švarų objektą.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="gallery" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <img src="https://picsum.photos/seed/cleaning-rags-sponges-professional/600/400" alt="Profesionalios valymo šluostės ir kempinės" class="gallery-img rounded-3xl shadow-lg w-full h-full object-cover">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-end mb-12">
                <div>
                    ...
                    <h2 class="text-5xl font-bold">Ką sako klientai apie Vilniaus valymą</h2>
                </div>
            </div>
    ...
    <section class="py-20 bg-white border-t border-b">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl font-bold mb-8">Profesionalus valymas Vilniuje – jūsų patikimas švaros partneris</h2>
            <p class="text-lg text-gray-600 leading-relaxed mb-6">Vilniaus valymas veikia nuo 2023 m. ir tapo mėgstamiausia paslauga šimtams šeimų ir įmonių. Specializuojamės butų, biurų ir po remonto valyme. Kiekvienas valymas – kompleksinis požiūris: dulkių siurbimas, grindų plovimas švabrėmis, vonios kambarių valymas kempinėmis, dulkių valymas šluostėmis, tik ekologiškos priemonės. Valome visuose Vilniaus rajonuose.</p>
        </div>
    </section>
    ...
    <footer class="bg-gray-900 text-white py-16">
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12">
            <div>
                <div class="flex items-center gap-3 text-3xl mb-6">
                    ...
                    <span class="font-bold">Vilniaus valymas</span>
                </div>
        ...
        <div class="mt-16 pt-8 border-t border-gray-800 text-center text-sm text-gray-500">
            ...
            <p class="mt-6">© 2026 Vilniaus valymas. Visos teisės saugomos.</p>
        </div>
    </footer>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "LocalBusiness",
      "name": "Vilniaus valymas",
      "description": "Profesionalus valymas Vilniuje – butų, biurų, po remonto ir generalinis valymas su ekologiškomis priemonėmis ir profesionalia įranga",
      "url": "https://bilohash.com/index.php",
